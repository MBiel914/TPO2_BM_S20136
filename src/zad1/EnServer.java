...
public class EnServer extends Thread {
	...
	public EnServer(String serverTID, ServerSocket ss) {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Init,EN," + ss.getLocalPort());
			out.println("Init,EN," + ss.getLocalPort());
		} catch (IOException e1) {
			System.out.println(e1.getMessage());
		}

		for (int i = 1; i <= SERVERS_NUM; i++) {
			new EnServer("serv thread " + i, ss);
		}
	}
}
